...
<html lang="en">
<head>
<title>Codeit-Admin-New Problem</title>
  ...
  <nav class="navbar navbar-inverse" style="background:#323754;margin-bottom:0px;">
   <div class="container-fluid">
     ...
     <ul class="nav navbar-nav">
       <li class="active"><a href="#">New Problem</a></li>
...
<div class="bgform">
<form action="addnewProcess.php" method="post">
...
<div class="container" >
  <div class="form-group">
    <input type="text" name="pbName" value="" class="form-control" placeholder="Problem Name">
  </div>
  <div class="form-group">
    <textarea name="pbStat" rows="8" cols="80" class="form-control" placeholder="Problem Statement"></textarea>
  </div>
  <div class="form-group">
    <label>Enter the Program Difficulty level</label><br>
  <label class="radio-inline"><input type="radio" name="diff" value="25" required>Easy</label>
  <label class="radio-inline"><input type="radio" name="diff" value="50" required>Moderate</label>
  <label class="radio-inline"><input type="radio" name="diff" value="100" required>Difficult</label>
...
<a href="#" data-toggle="tooltip" title="Difficulty Levels are Given specific xps points. Easy - 25XPS, Moderate - 50XPS, Difficult - 100XPS" style="margin-left:50px;">Help</a>
  ...
  <div class="form-group onerow">
    <textarea name="ips1" id="ips1" rows="8" cols="40" class="form-control" placeholder="Inputs for case 1"></textarea>
  </div>
  <div class="form-group onerow">
    <textarea name="ips2" id="ips2" rows="8" cols="40" class="form-control" placeholder="Inputs for case 2"></textarea>
  </div><br>
  <div class="form-group secrow">
    <textarea name="ips3" id="ips3" rows="8" cols="40" class="form-control" placeholder="Inputs for case 3"></textarea>
  </div>
  <div class="form-group secrow">
    <textarea name="ips4" id="ips4" rows="8" cols="40" class="form-control" placeholder="Inputs for case 4"></textarea>
  </div><br>
...
<a href="#" data-toggle="tooltip" title="You can get the output of the Program. You need to write the full working program and then click on this button. The outputs will appear on the boxes below" style="margin-left:50px;">Help</a>
  ...
  <div class="form-group thirdrow">
    <textarea name="ops1" id="ops1" rows="8" cols="40" class="form-control" placeholder="Output for case 1"></textarea>
  </div>
  <div class="form-group thirdrow">
    <textarea name="ops2" id="ops2" rows="8" cols="40" class="form-control" placeholder="Output for case 2"></textarea>
  </div><br>
  <div class="form-group frow">
    <textarea name="ops3" id="ops3" rows="8" cols="40" class="form-control" placeholder="Output for case 3"></textarea>
  </div>
  <div class="form-group frow">
    <textarea name="ops4" id="ops4" rows="8" cols="40" class="form-control" placeholder="Output for case 4"></textarea>
  </div><br>
